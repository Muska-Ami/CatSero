...
public class Main extends JavaPlugin implements Listener {
    ...
    @Override // 加载插件
    public void onLoa() {
        Bukkit.getLogger().info(ChatColor.translateAlternateColorCodes('&', "[CatSero] &eCatSero加载中..."));
    }
    ...
    public void onEnable() {
        ...
        Bukkit.getLogger().info(ChatColor.translateAlternateColorCodes('&', "[CatSero] &a插件加载完毕！"));
    }

    @Override // 禁用插件
    public void onDisable() {
        Bukkit.getLogger().info(ChatColor.translateAlternateColorCodes('&', "[CatSero] &c关闭CatSero..."));
    }
