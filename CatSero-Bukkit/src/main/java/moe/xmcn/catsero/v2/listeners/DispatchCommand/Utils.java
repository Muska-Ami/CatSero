...
public interface Utils {
    ...
    String X_Bot = Configs.JPConfig.uses_config.getString("dispatch-command.var.bot");
    String X_Group = Configs.JPConfig.uses_config.getString("dispatch-command.var.group");
